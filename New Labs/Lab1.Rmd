...
3. Record the sentence: __“My name is [first-name] [last-name]”__
...
<font size= "4.5"> <br>
**Upload to eClass** a PDF with your answers to the following questions as well as the .wav and .TextGrid files that you created for this lab. Each student must complete and submit this lab on their own.
