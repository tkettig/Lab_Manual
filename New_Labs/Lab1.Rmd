...
***
#### __Goal of Lab 1:__
##### The goal of this first lab is to explore some of the basic features of [PRAAT](www.praat.org), which we will be using for speech analysis throughout the term. You will:

##### 1. Learn to make recordings
##### 2. Bring up visual displays of these recordings (waveforms and spectrograms)
##### 3. Segment and label various components of these recordings
##### 4. Export the visual displays into a word document. 
