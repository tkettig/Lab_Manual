...
>__TIP:__
Praat can sometimes introduce a "ghost" formant which can be rectified by raising the LPC setting maximum and/or reeducing the number of formants that the software should account for. The only way to ensure that there are no "ghost" formants is by taking into account the vowel that you're analysing, determining where the different formants are located and seeing whether Praat is matching this analysis.
