...
Go to eClass and download the zip file "Lab6_Soundfiles", containing the following files. Note, you can also generate these sound files or, optionally, you can use your "a_stop_a.wav" and "a_stop.wav" files from Lab 2 or 5 and generate the other two sound files.
