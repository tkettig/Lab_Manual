...
>
Also, if you are using a Windows system, ensure that your 'analysis method' under Pitch settings is set to __raw autocorrelation__ to get the correct display for the pitch contours.
